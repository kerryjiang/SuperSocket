...
%msbuild% ClientEngine\SuperSocket.ClientEngine.MonoDroid.csproj /p:Configuration=Debug /t:Clean;Rebuild /p:SignAssembly=true /p:AssemblyOriginatorKeyFile=..\supersocket.snk
FOR /F "tokens=*" %%G IN ('DIR /B /AD /S obj') DO RMDIR /S /Q "%%G"

%msbuild% ClientEngine\SuperSocket.ClientEngine.MonoDroid.csproj /p:Configuration=Release /t:Clean;Rebuild /p:SignAssembly=true /p:AssemblyOriginatorKeyFile=..\supersocket.snk
FOR /F "tokens=*" %%G IN ('DIR /B /AD /S obj') DO RMDIR /S /Q "%%G"
