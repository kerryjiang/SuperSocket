...
{
    public abstract partial class PipeConnection<TPackageInfo> : ConnectionBase<TPackageInfo>, IConnection<TPackageInfo>, IConnection, IPipeConnection
    {
        ...
        protected PipeConnection(IPipelineFilter<TPackageInfo> pipelineFilter, ConnectionOptions options)
        {
